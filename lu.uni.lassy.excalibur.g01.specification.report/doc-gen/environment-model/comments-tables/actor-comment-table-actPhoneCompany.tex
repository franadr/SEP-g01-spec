...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actPhoneCompany.outactPhoneCompany.oeGetConfirm}
			...
			{}
	\addnumbereddoublerow{OUT}{\hypertarget{actPhoneCompany.outactPhoneCompany.oeSendDeliveryReport}
			{\msrcode{oeSendDeliveryReport(AdtMessage:dtMessage, AdtPhoneNumber:dtPhoneNumber):ptBoolean}}}
			{ }
	
	\addrowheading{InputInterfaces}
	\addnumbereddoublerow{IN}{\msrcode{ieRequestConfirm(AdtPhoneNumber:dtPhoneNumber):ptBoolean}}
							 {}
	\addnumbereddoublerow{IN}{\msrcode{ieSmsForFamily(AdtMessage:dtMessage, AdtPhoneNumber:dtPhoneNumber):ptBoolean}}
							 {}
